...
author: 
- name: Manuel Ugidos
  affiliation: Gene Expression and RNA Metabolism Laboratory, Instituto de Biomedicina de Valencia, Consejo Superior de Investigaciones Cient\'ificas (CSIC), Valencia, Spain.
- name: Sonia Tarazona
  affiliation: Multivariate Statistical Engineering Group, Department of Applied Statistics, Operations Research and Quality, Universitat Polit\`{e}cnica de Val\`{e}ncia, Valencia, Spain
- name: Maria J. Nueda
